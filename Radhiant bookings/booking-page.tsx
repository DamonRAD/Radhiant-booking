...
const mockVanSchedules = {
  "Cape Town": {
    ...
    bookedSlots: [
      ...
      { date: addDays(new Date(), 1), slot: "16:00" },
      { date: addDays(new Date(), 2), slot: "11:00" },
      { date: addDays(new Date(), 2), slot: "11:15" },
      { date: addDays(new Date(), 2), slot: "12:00" },
      { date: addDays(new Date(), 2), slot: "13:00" },
    ],
  },
  Johannesburg: {
    vanId: "VAN-002",
...
export default function BookingPage() {
  ...
  const canProceedFromStep = (step: number) => {
    switch (step) {
      ...
      case 3:
        // Special requirements and referring doctor are optional
        return true
      case 4:
        const {
          firstName,
        ...
        const basicFieldsFilled = firstName !== "" && lastName !== "" && idNumber !== "" && phone !== "" && email !== ""
        ...
        // If medical aid is selected (and not "none"), then medical aid fields are required
        if (medicalAid && medicalAid !== "" && medicalAid !== "none") {
          const medicalAidFieldsFilled =
            medicalAidSchemeName !== "" &&
            medicalAidPlan !== "" &&
            medicalAidNumber !== "" &&
            relationshipToMainMember !== "" &&
            hasGapCover !== "" &&
            requiresPreAuth !== ""
          return basicFieldsFilled && emergencyContactFilled && medicalAidFieldsFilled
        }

        return basicFieldsFilled && emergencyContactFilled
      default:
        return false
    }
  }
          ...
          <CardContent className="space-y-4">
            <div className="bg-slate-50 p-4 rounded-lg space-y-2 border border-slate-200">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-slate-900">{bookingData.town}</span>
              </div>
              <div className="flex justify-between">
                ...
                {step < 4 && (
                  <div
                    className={`w-12 h-1 mx-2 transition-all duration-300 ${
                      step < currentStep ? "bg-gradient-to-r from-green-500 to-green-600" : "bg-slate-700"
                    }`}
                  />
                )}
              </div>
          ...
          <CardContent className="space-y-6 p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setBookingData({ ...bookingData, province: value, town: "" })}
                  >
                    <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                      <SelectValue placeholder="Select your province" />
                    </SelectTrigger>
                    <SelectContent>
                      {Object.keys(southAfricanData).map((province) => (
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-slate-800 border-b border-slate-200 pb-2">
                    Referring Doctor Information (Optional)
                  </h3>
                  ...
                  <div>
                    ...
                    <Input
                      id="doctorName"
                      placeholder="Full name of referring doctor"
                      value={bookingData.referringDoctor.name}
                      onChange={(e) =>
                        setBookingData({
                          ...bookingData,
                          referringDoctor: {
                            ...bookingData.referringDoctor,
                            name: e.target.value,
                          },
                        })
                      }
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="practiceNumber" className="text-slate-700 font-medium">
                        Practice Number
                      </Label>
                      <Input
                        id="practiceNumber"
                        placeholder="Doctor's practice number"
                        value={bookingData.referringDoctor.practiceNumber}
                        onChange={(e) =>
                          setBookingData({
                            ...bookingData,
                            referringDoctor: {
                    ...
                    <div>
                      <Label htmlFor="doctorContact" className="text-slate-700 font-medium">
                        Contact Number
                      </Label>
                      <Input
                        id="doctorContact"
                        placeholder="Doctor's contact number"
                        value={bookingData.referringDoctor.contactNumber}
                        onChange={(e) =>
                          setBookingData({
                            ...bookingData,
                            referringDoctor: {
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start space-x-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <p>
                      Providing referring doctor information may help with medical aid claims and ensure proper
                      follow-up care. This information is optional but recommended.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="emergencyName" className="text-slate-700 font-medium">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="emergencyRelationship" className="text-slate-700 font-medium">
                        Relationship
                      </Label>
                      <Select
                        ...
                        onValueChange={(value) =>
                          setBookingData({
                            ...bookingData,
                            emergencyContact: { ...bookingData.emergencyContact, relationship: value },
                          })
                        }
                      >
                        <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                ...
                <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg">
                  <p className="text-blue-800 font-medium text-center">Cash price R1200, medical aid options below</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="medicalAid" className="text-slate-700 font-medium">
                      Do you have Medical Aid?
                    </Label>
                    <Select
                      value={bookingData.patientDetails.medicalAid}
                      onValueChange={(value) =>
                        setBookingData({
                          ...bookingData,
                          patientDetails: {
                            ...bookingData.patientDetails,
                            medicalAid: value,
                            // Clear all medical aid fields if "none" is selected
                            ...(value === "none" && {
                              medicalAidSchemeName: "",
                              medicalAidPlan: "",
                              medicalAidNumber: "",
                    ...
                    >
                      <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                        <SelectValue placeholder="Select medical aid option" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="none">No Medical Aid</SelectItem>
                        <SelectItem value="yes">Yes, I have Medical Aid</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>

                  {/* Medical Aid Details - Only show if they have medical aid */}
                  {bookingData.patientDetails.medicalAid === "yes" && (
                    <div className="p-4 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-lg space-y-4">
                      <h4 className="font-medium text-blue-800 mb-3">Medical Aid Details</h4>

                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="medicalAidSchemeName" className="text-slate-700 font-medium">
                            Medical Aid Scheme Name
                          </Label>
                          <Select
                            value={bookingData.patientDetails.medicalAidSchemeName}
                            onValueChange={(value) =>
                              setBookingData({
                                ...bookingData,
                                patientDetails: {
                                  ...bookingData.patientDetails,
                                  medicalAidSchemeName: value,
                                  // Clear the plan when scheme changes
                                  medicalAidPlan: "",
                                },
                              })
                            }
                          >
                            ...
                            <SelectContent>
                              {Object.keys(medicalAidSchemes).map((scheme) => (
                        ...
                        <div>
                          <Label htmlFor="medicalAidPlan" className="text-slate-700 font-medium">
                            Medical Aid Plan / Option
                          </Label>
                          <Select
                            value={bookingData.patientDetails.medicalAidPlan}
                            onValueChange={(value) =>
                              setBookingData({
                                ...bookingData,
                                patientDetails: { ...bookingData.patientDetails, medicalAidPlan: value },
                              })
                            }
                            disabled={!bookingData.patientDetails.medicalAidSchemeName}
                          >
                            <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                              <SelectValue
                                placeholder={
                                  bookingData.patientDetails.medicalAidSchemeName
                                    ? "Select your plan/option"
                                    : "First select a medical aid scheme"
                                }
                              />
                            </SelectTrigger>
                            <SelectContent>
                              {bookingData.patientDetails.medicalAidSchemeName &&
                                medicalAidSchemes[
                                  bookingData.patientDetails.medicalAidSchemeName as keyof typeof medicalAidSchemes
                                ]?.plans.map((plan) => (
                      ...
                      <div>
                        <Label htmlFor="medicalAidNumber" className="text-slate-700 font-medium">
                          Medical Aid Membership Number
                        </Label>
                        <Input
                          id="medicalAidNumber"
                          placeholder="As shown on your medical aid card"
                          value={bookingData.patientDetails.medicalAidNumber}
                          onChange={(e) =>
                            setBookingData({
                              ...bookingData,
                              patientDetails: { ...bookingData.patientDetails, medicalAidNumber: e.target.value },
                            })
                          }
                          className="border-slate-300 focus:border-green-500 focus:ring-green-500"
                        />
                      ...
                      <div>
                        <Label htmlFor="relationshipToMainMember" className="text-slate-700 font-medium">
                          Relationship to Main Member
                        </Label>
                        <Select
                          value={bookingData.patientDetails.relationshipToMainMember}
                          onValueChange={(value) =>
                            setBookingData({
                              ...bookingData,
                              patientDetails: { ...bookingData.patientDetails, relationshipToMainMember: value },
                            })
                          }
                        >
                          <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                          ...
                          <SelectContent>
                            <SelectItem value="self">Self (Main Member)</SelectItem>
                            <SelectItem value="spouse">Spouse</SelectItem>
                            <SelectItem value="child">Child</SelectItem>
                            <SelectItem value="other">Other</SelectItem>
                          </SelectContent>
                      ...
                      {/* Main Member Details - Only show if not self */}
                      {bookingData.patientDetails.relationshipToMainMember &&
                        bookingData.patientDetails.relationshipToMainMember !== "self" && (
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <Label htmlFor="mainMemberName" className="text-slate-700 font-medium">
                                Main Member's Full Name
                              </Label>
                              <Input
                                id="mainMemberName"
                                placeholder="Main member's full name"
                                value={bookingData.patientDetails.mainMemberName}
                                onChange={(e) =>
                                  setBookingData({
                                    ...bookingData,
                                    patientDetails: { ...bookingData.patientDetails, mainMemberName: e.target.value },
                                  })
                                }
                                className="border-slate-300 focus:border-green-500 focus:ring-green-500"
                              />
                            ...
                            <div>
                              <Label htmlFor="mainMemberIdNumber" className="text-slate-700 font-medium">
                                Main Member's ID Number
                              </Label>
                              <Input
                                id="mainMemberIdNumber"
                                placeholder="Main member's ID number"
                                value={bookingData.patientDetails.mainMemberIdNumber}
                                onChange={(e) =>
                                  setBookingData({
                                    ...bookingData,
                                    patientDetails: {
                                      ...bookingData.patientDetails,
                                      mainMemberIdNumber: e.target.value,
                                    },
                                  })
                                }
                                className="border-slate-300 focus:border-green-500 focus:ring-green-500"
                      ...
                      <div>
                        <Label htmlFor="dependentCode" className="text-slate-700 font-medium">
                          Dependent Code / Number (Optional)
                        </Label>
                        <Select
                          value={bookingData.patientDetails.dependentCode}
                          onValueChange={(value) =>
                            setBookingData({
                              ...bookingData,
                              patientDetails: { ...bookingData.patientDetails, dependentCode: value },
                            })
                          }
                        >
                          <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                            <SelectValue placeholder="Select dependent code" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="not_applicable">Not applicable</SelectItem>
                            <SelectItem value="00">00 (Main Member)</SelectItem>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label htmlFor="medicalAidContactNumber" className="text-slate-700 font-medium">
                            Medical Aid Contact Number (Optional)
                          </Label>
                          <Input
                            id="medicalAidContactNumber"
                            placeholder="Medical aid contact number"
                            value={bookingData.patientDetails.medicalAidContactNumber}
                            onChange={(e) =>
                              setBookingData({
                                ...bookingData,
                                patientDetails: {
                                  ...bookingData.patientDetails,
                                  medicalAidContactNumber: e.target.value,
                                },
                              })
                            }
                            className="border-slate-300 focus:border-green-500 focus:ring-green-500"
                      ...
                      <div>
                        <Label htmlFor="hasGapCover" className="text-slate-700 font-medium">
                          Do you have a Gap Cover Policy?
                        </Label>
                        <Select
                          value={bookingData.patientDetails.hasGapCover}
                          onValueChange={(value) =>
                            setBookingData({
                              ...bookingData,
                              patientDetails: {
                                ...bookingData.patientDetails,
                                hasGapCover: value,
                                // Clear gap cover insurer if "no" is selected
                                ...(value === "no" && { gapCoverInsurer: "" }),
                              },
                            })
                          }
                        >
                          <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                            <SelectValue placeholder="Select gap cover option" />
                          </SelectTrigger>
                          <SelectContent>
                      ...
                      {/* Gap Cover Insurer - Only show if they have gap cover */}
                      {bookingData.patientDetails.hasGapCover === "yes" && (
                        <div>
                          <Label htmlFor="gapCoverInsurer" className="text-slate-700 font-medium">
                            Gap Cover Insurer Name
                          </Label>
                          <Select
                            value={bookingData.patientDetails.gapCoverInsurer}
                            onValueChange={(value) =>
                              setBookingData({
                                ...bookingData,
                                patientDetails: { ...bookingData.patientDetails, gapCoverInsurer: value },
                              })
                            }
                          >
                            <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                              <SelectValue placeholder="Select your gap cover insurer" />
                            </SelectTrigger>
                            <SelectContent>
                              {gapCoverInsurers.map((insurer) => (
                      ...
                      <div>
                        <Label htmlFor="requiresPreAuth" className="text-slate-700 font-medium">
                          Do you require pre-authorization for today's service?
                        </Label>
                        <Select
                          value={bookingData.patientDetails.requiresPreAuth}
                          onValueChange={(value) =>
                            setBookingData({
                              ...bookingData,
                              patientDetails: { ...bookingData.patientDetails, requiresPreAuth: value },
                            })
                          }
                        >
                          <SelectTrigger className="border-slate-300 focus:border-green-500 focus:ring-green-500">
                            <SelectValue placeholder="Select pre-authorization requirement" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="no">No</SelectItem>
                            <SelectItem value="yes">Yes</SelectItem>
